...
namespace WinTrayMemory.MainPage.Components.MemoryUsage;

public partial class MemoryUsageViewModel : ObservableObject
{
    [ObservableProperty]
    ...
    /// <summary>
    /// initializes the memory usage view model and starts periodic ram updates.
    /// </summary>
    public MemoryUsageViewModel()
    {
